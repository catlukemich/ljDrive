...
public class WindowConstants {
	...
	public static final int FR_LOWERED = 0x20; /// < If set the frame is lowered and the background color brighter (ie.
												/// buttons when pressed)
	public static final int FR_DARKENED = 0x40; /// < If set the background is darker; allows for lowered frames with
												/// normal background color when used with FR_LOWERED (ie. dropdown
												/// boxes)
	...
	public static final int WDP_AUTO = -1; // WinDow Position AUTO
	public static final int WDP_CENTER = -2; // WinDow Position CENTER

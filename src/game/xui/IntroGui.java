...
public class IntroGui
{
	...
	static final Widget _select_game_widgets[] = {
		// 							Type				Flags Clr l      r    t   b,  Str or im,				   Tooltip
		new Widget(Window.WWT_CAPTION	, Window.RESIZE_NONE, 13, 0  , 335,   0, 13 , Str.STR_0307_OPENTTD,       	Str.STR_NULL),
		new Widget(Window.WWT_PANEL		, Window.RESIZE_NONE, 13, 0  , 335,  14, 218, Str.STR_NULL,               	Str.STR_NULL), // Hideous bitch - it's a frame bacground!
		...
		new Widget(Window.WWT_PUSHTXTBTN, Window.RESIZE_NONE, 12, 10,  325, 195, 208, Str.STR_0020_GOLD,		   	Str.STR_0001_OFF_EDGE_OF_MAP   )
	};
	//@format
	...
	static final int mapsizes[] = {
		Str.STR_64, Str.STR_128, Str.STR_256, Str.STR_512, Str.STR_1024, Str.STR_2048, Str.INVALID_STRING
	};
	...
	static void SelectGameWndProc(Window w, WindowEvent e) {
		...
		case WE_CLICK:
			...
			case 4:
				...
				break;
			case 5:
				MiscGui.ShowSaveLoadDialog(Global.SLD_LOAD_SCENARIO);
				break;
			case 6:
			case 7:
			case 8:
			...
			case 15:
				...
				break;
			case 16:
				SettingsGui.ShowGameOptions();
				break;
			case 17:
				SettingsGui.ShowGameDifficulty();
				break;
			case 18:
				SettingsGui.ShowPatchesSelection();
				break;
			case 19:
				AskExitGame();
				break;
		...
		case WE_ON_EDIT_TEXT:
			Gui.HandleOnEditText(e);
			break;
		case WE_ON_EDIT_TEXT_CANCEL:
			Gui.HandleOnEditTextCancel();
			break;

		case WE_DROPDOWN_SELECT: /* Mapsize selection */
			switch (e.button) {
			case 11:
				Global._patches.map_x = e.index + 6;
				break;
			case 13:
				Global._patches.map_y = e.index + 6;
				break;
			}
			w.SetWindowDirty();
			break;
	...
	static final WindowDesc _select_game_desc = new WindowDesc(Window.WDP_CENTER, Window.WDP_CENTER, 336, 218, Window.WC_SELECT_GAME, 0, WindowDesc.WDF_STD_TOOLTIPS | WindowDesc.WDF_DEF_WIDGET | WindowDesc.WDF_UNCLICK_BUTTONS,

		_select_game_widgets, IntroGui::SelectGameWndProc);
	...
	static final Widget _ask_abandon_game_widgets[] = {
		new Widget(Window.WWT_CLOSEBOX, Window.RESIZE_NONE, 4, 0, 10, 0, 13, Str.STR_00C5, Str.STR_018B_CLOSE_WINDOW), new Widget(Window.WWT_CAPTION, Window.RESIZE_NONE, 4, 11, 179, 0, 13, Str.STR_00C7_QUIT, Str.STR_NULL), new Widget(Window.WWT_IMGBTN, Window.RESIZE_NONE, 4, 0, 179, 14, 91, 0x0, Str.STR_NULL), new Widget(Window.WWT_TEXTBTN, Window.RESIZE_NONE, 12, 25, 84, 72, 83, Str.STR_00C9_NO, Str.STR_NULL),
	...
	static final WindowDesc _ask_abandon_game_desc = new WindowDesc(Window.WDP_CENTER, Window.WDP_CENTER, 180, 92, Window.WC_ASK_ABANDON_GAME, 0, WindowDesc.WDF_STD_TOOLTIPS | WindowDesc.WDF_DEF_WIDGET | WindowDesc.WDF_STD_BTN | WindowDesc.WDF_UNCLICK_BUTTONS, _ask_abandon_game_widgets, IntroGui::AskAbandonGameWndProc);
	...
	static final Widget _ask_quit_game_widgets[] = {
		new Widget(Window.WWT_CLOSEBOX, Window.RESIZE_NONE, 4, 0, 10, 0, 13, Str.STR_00C5, Str.STR_018B_CLOSE_WINDOW), new Widget(Window.WWT_CAPTION, Window.RESIZE_NONE, 4, 11, 179, 0, 13, Str.STR_0161_QUIT_GAME, Str.STR_NULL), new Widget(Window.WWT_IMGBTN, Window.RESIZE_NONE, 4, 0, 179, 14, 91, 0x0, Str.STR_NULL), new Widget(Window.WWT_TEXTBTN, Window.RESIZE_NONE, 12, 25, 84, 72, 83, Str.STR_00C9_NO, Str.STR_NULL),
		new Widget(Window.WWT_TEXTBTN, Window.RESIZE_NONE, 12, 95, 154, 72, 83, Str.STR_00C8_YES, Str.STR_NULL),
	};
	...
	static void AskQuitGameWndProc(Window w, WindowEvent e) {
		...
		case WE_PAINT:
			w.DrawWindowWidgets();
			Gfx.DrawStringMultiCenter(90, 38, Global._game_mode != GameModes.GM_EDITOR ? Str.STR_0160_ARE_YOU_SURE_YOU_WANT_TO : Str.STR_029B_ARE_YOU_SURE_YOU_WANT_TO, 178);
			break;
	...
	static final WindowDesc _ask_quit_game_desc = new WindowDesc(Window.WDP_CENTER, Window.WDP_CENTER, 180, 92, Window.WC_QUIT_GAME, 0, WindowDesc.WDF_STD_TOOLTIPS | WindowDesc.WDF_DEF_WIDGET | WindowDesc.WDF_STD_BTN | WindowDesc.WDF_UNCLICK_BUTTONS, _ask_quit_game_widgets, IntroGui::AskQuitGameWndProc);
